      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex flex-col justify-center space-y-6 p-8">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-primary-400 to-purple-400 rounded-3xl transform rotate-3 opacity-20"></div>
            <div className="relative bg-white rounded-3xl p-8 shadow-soft">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Employee Management</p>
                    <p className="text-sm text-gray-500">Track and manage your team</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Analytics & Reports</p>
                    <p className="text-sm text-gray-500">Insights at your fingertips</p>
                  </div>
                </div>
              </div>
            </div>
